...
module.exports = {
    ...
    cpuClocks: function(fromData) {
        var data = fromData || module.exports.readAIDA64Sync();
        
        var clocks = [];
        data.sys.forEach(function(entry) {
            if(entry.id.match(/SCC-1-\d+/)) {
                clocks.push(entry.value);
            }
        });
